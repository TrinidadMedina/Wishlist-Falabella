				...
				<>
					...
					<div className="flex justify-between mt-[75px] border-slate-300">
						<div className="grid grid-flow-col items-center">
							...
							<Pencil />
							<button onClick={() => {setPopUpEdit(true)}} className="text-xs underline text-ocho ml-1">
								Editar
							</button>
						</div>
						<button onClick={() => setPopUpDeleteList(true)} className="text-xs justify-self-end self-end underline text-ocho">
							Eliminar lista
						</button>
					</div>
